...
export class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playlistTracks: [{name: 'Poker Face', artist: 'Lady Gaga', album: 'Facts', id:4}, {name: 'Roar', artist: 'Kate Perry', album: 'Last night', id:5}, 
      {name: 'Million', artist: 'Kate Melua', album: "Very first", id:6}]
    }
